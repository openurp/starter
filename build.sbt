...
ThisBuild / version := "0.3.50-SNAPSHOT"
...
lazy val web = (project in file("web"))
  .settings(
    ...
    libraryDependencies ++= Seq(beangle_model, beangle_cdi, beangle_webmvc, beangle_doc_transfer, beangle_template),
